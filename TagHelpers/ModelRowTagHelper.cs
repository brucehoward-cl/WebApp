...
namespace WebApp.TagHelpers
{
    ...
    public class ModelRowTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            th.InnerHtml.Append(For.Name.Split(".").Last());  // this is one way to handle how the razor page model (Editor.cshtml) ModelExpression.Name contains the whole nested property name

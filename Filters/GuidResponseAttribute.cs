...
namespace WebApp.Filters
{
    ...
    public class GuidResponseAttribute : Attribute, IAsyncAlwaysRunResultFilter, IFilterFactory
    {
        ...
        public bool IsReusable => false;        //IFilterFactory interface
        public IFilterMetadata CreateInstance(IServiceProvider serviceProvider) //IFilterFactory interface
        {
        ...
        public async Task OnResultExecutionAsync(ResultExecutingContext context, ResultExecutionDelegate next)
        {
            ...
            else
            {
                ...
                context.Result = new ViewResult()
                {
                    ...
                    ViewData = new ViewDataDictionary(new EmptyModelMetadataProvider(), new ModelStateDictionary()) { Model = resultData }
                };
            }
